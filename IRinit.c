...
/* Enable GPIOs clock */ 	
	...
	GPIOE->OSPEEDR |= 3U<<(2*15) | 3U<<28 | 3U<<26 | 3U<<24;   	//High speed
	
	// GPIO Output Type: Output push-pull (0, reset), Output open drain (1) 
	GPIOE->OTYPER &= ~(1U<<15 | 1U<<14 | 1U<<13 | 1U<<12);       // Push-pull

	// GPIO Push-Pull: No pull-up, pull-down (00), Pull-up (01), Pull-down (10), Reserved (11)
	GPIOE->PUPDR   &= ~(3U<<(2*15) | 3U<<28 | 3U<<26 | 3U<<24);  // No pull-up, no pull-down
}
